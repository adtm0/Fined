...
def dashboard(request):
  ...
  all_transactions = Transaction.objects.filter(user=request)
  total_income = sum(transactions.income for transaction in transactions)
  total_spending = sum(transactions.expense for transaction in transactions)
