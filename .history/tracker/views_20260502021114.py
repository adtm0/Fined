...
def edit_transaction(request, transaction_id):
  ...
  if request.method == 'POST':
    ...
    if form.is_valid():
      ...
      Activity.objects.create(
        user=request.user,
        activity_type='transaction_edited',
        description=f'{transaction.description or transaction.type} edited',
        amount = transaction.amount,
        transaction_type=transaction.type,
      )
...
def delete_transaction(request, transaction_id):
  ...
  Activity.objects.create(
    ...
    description=f'{transaction.description or transaction.type} deleted',
    amount=transaction.amount,
    transaction_type=transaction.type,
  )
  transaction.delete()
...
def edit_account(request, account_id):
  ...
  if request.method =='POST':
    ...
    if form.is_valid():
      ...
      Activity.objects.create(
        user=request.user,
        activity_type='account_edited',
        description=f'{account.name} account edited'
      )
      return redirect('dashboard')
  else:
...
def delete_account(request, account_id):
  ...
  Activity.objects.create(
    ...
    description=f'{account.name} account deleted',
  )
  account.delete()
  return redirect('dashboard')
